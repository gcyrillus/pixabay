...
<p>utilise l'api des banques d'images pixabay et pexels pour rechercher, afficher et choisir une image à uploader sur votre PluXml.
...
<div id="tabContainer">
	<form action="parametres_plugin.php?p=<?= basename(__DIR__) ?>" method="post" >
		<div class="tabs">
			<ul>
				<li id="tabHeader_Param">Pixabay Key</li>	
			</ul>
		</div>
		<div class="tabscontent">
			<div class="tabpage" id="tabpage_Param">	
				<fieldset><legend><?= $plxPlugin->getLang('L_YOUR_KEY') ?></legend>
					<p>
						<?php plxUtils::printInput('apikey',$plxPlugin->apikey,'text','30-50') ?>		
					</p>	
				</fieldset>
			</div>
